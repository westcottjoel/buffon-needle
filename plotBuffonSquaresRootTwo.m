function [r,crossings] = plotBuffonSquaresPi(ax,throws,length,width)
  ...
  for i=1:throws
    ...
    if floor(y4/width) ~= floor(y1(i)/width)
    	...
    	if crossings1 == crossings2 || crossings2 == crossings3 || crossings3==crossings4 || crossings4==crossings1
